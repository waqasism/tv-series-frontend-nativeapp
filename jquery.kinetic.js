...
(function($){
    ...
    var initElements = function(options) {
        this.each(function(){
            ...
            var useTarget = function(target,e ) {
                if ($.isFunction(settings.filterTarget)) {
                    return settings.filterTarget.call(self, target, e) !== false;
                }
                return true;
            };
            ...
            settings.events = {
                ...
                inputEnd: function(e){
                    ...
                    if(prevXPos ==0 && prevYPos == 0 ) useTarget(e.target, e);
    ...
    $.kinetic = {
        ...
        callMethods: {
            ...
            new_stop: function(){
                ...
                var $this = $(this);
                var settings = $this.data().kineticSettings;
