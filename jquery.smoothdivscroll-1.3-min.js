    ...
    $.widget("thomaskahn.smoothDivScroll", {
        options: {
            ...
            $(window).bind("resize", function () {
                if ((self.element.data("scrollableAreaWidth") -
                    (self.element.data("scrollableArea").children().length * 15))
                    <= self.element.data("scrollWrapper").width()
                ) {
                    self.disable();
                }
                else {
            ...
            $(window).load(function () {
                ...
                if (o.autoScrollingMode !== "always") {
                    console.log(o.visibleHotSpotBackgrounds);
            ...
            //             var srollable = (self.element.data("scrollableAreaWidth") -(self.element.data("scrollableArea").children().length * 15))
            //             var scrollablew = self.element.data("scrollWrapper").width()
            //             var difscrollable = scrollablew - srollable
            //            console.log(  scrollablew , srollable , difscrollable)
            //             if(difscrollable >= -90 && difscrollable <= 100)
            // {
            //     console.log('a')

            //     $( ".scrollableArea  span:last-of-type" ).after( $('<span class="separator"><img src="assets/images/separator.png" alt=""/></span>') );
            ...
            if (fadeSpeed !== undefined) {
                ...
                el.data("scrollingHotSpotLeft").add(el.data("scrollingHotSpotRight")).fadeTo(fadeSpeed, 0.99)
            } else {
                el.data("scrollingHotSpotLeft").addClass(o.scrollingHotSpotLeftVisibleClass);
            ...
            //console.log('imgWidth: ' + o.imgWidth);
            el.data("scrollableArea").children().each(function () {
                if ((o.startAtElementId.length > 0) && (($(this).attr("id")) === o.startAtElementId)) {
                    el.data("startingPosition", tempScrollableAreaWidth);
                    foundStartAtElement = true
                }
                tempScrollableAreaWidth = tempScrollableAreaWidth + (o.imgWidth + 30);
            });
            if (!(foundStartAtElement)) {
                el.data("startAtElementId", "")
            }
            //console.log("tempScrollableAreaWidth: " + tempScrollableAreaWidth);
            ...
            if (el.data("scrollWrapper").scrollLeft() === 0) {
                ...
                var srollable = (el.data("scrollableAreaWidth") - (el.data("scrollableArea").children().length * 15))
                var scrollablew = el.data("scrollWrapper").width()
                var difscrollable = scrollablew - srollable
                if (difscrollable >= -80 && difscrollable <= 100) {
                }
                else {
                    el.data("swappedElement", el.data("scrollableArea").children(":last").detach());
                    el.data("scrollableArea").prepend(el.data("swappedElement"));
